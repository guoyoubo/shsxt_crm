...
<link href="${ctx}/public/static/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
<link href="${ctx}/public/static/css/uniform.default.css" rel="stylesheet" type="text/css"/>
<link href="${ctx}/public/static/css/login.css" rel="stylesheet" type="text/css"/>
<link href="${ctx}/public/static/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" src="${ctx}/public/static/jquery-easyui-1.3.3/jquery.min.js"></script>
	<script type="text/javascript" src="${ctx}/public/static/js/jquery.cookie.js"></script>
<script type="text/javascript" src="${ctx}/public/static/js/common.js"></script>
	<script type="text/javascript">
		var ctx="${ctx}";
	</script>
	<script type="text/javascript" src="${ctx}/public/static/js/index.js"></script>
